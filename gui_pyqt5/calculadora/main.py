...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Título da interface.
        self.setWindowTitle('Calculadora github.com/ViiniciusK9')
        ...
        self.add_btn(
            ...
            'background: #5E5E5E; color: #fff; font-weight: 700;'
        )
        self.add_btn(
            QPushButton('←'), 1, 4, 1, 1,
            lambda: self.display.setText(
    ...
    def add_btn(self, btn, wor, col, rowspan, colspan, funcao=None, style=None):
        self.grid.addWidget(btn, wor, col, rowspan, colspan)
        if not funcao:
            btn.clicked.connect(
                lambda: self.display.setText(
        ...
        if style:
            btn.setStyleSheet(style + 'font-size: 15px')
        else:
