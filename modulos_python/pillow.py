...
def main(main_images_folder, new_width=800):
    ...
    for root, dirs, files in os.walk(main_images_folder):
        for file in files:
            ...
            # Apagar imagens com a tag _CONVERTED.
            ...
            # Regra de 3 para calcular a nova altura proporcional a lagura enviada na função.
            ...
            # Apagar imagens originais.
            # os.remove(file_full_path)


if __name__ == '__main__':
    # Caminho para as imagens
    main_images_folder = 'caminho' 
